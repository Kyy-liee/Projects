...
app.layout = html.Div([
    ...
    html.Div(id='out-container', className='chart-grid', style={'display': 'flex'}),])
])
...
def update_output_container(selected_statistics, selected_year):
    if selected_statistics == 'Recession Period Statistics':
        ...
        return f"Recession period data: {len(recession_data)} records found."
    elif selected_statistics == 'Yearly Statistics' and selected_year is not None:
        yearly_data = data[data['Year'] == selected_year]
        return f"Year {selected_year} data: {len(yearly_data)} records found."
    else:
        return "Please select a report type and (if needed) a year."
